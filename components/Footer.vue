<template>
  <footer class="py-10 md:mt-10 text-white bg-black">
    <div
      class="container gap-8 space-y-8 md:grid md:grid-cols-3 lg:grid-cols-5 md:space-y-0"
    >
      <!-- Exclusive Section -->
      <div class="space-y-4">
        ...
        <form @submit.prevent="handleSubmit" class="relative flex mt-4">
          <div class="relative">
            <input
              ...
              v-model="email"
              class="bg-transparent w-full px-4 py-3 border border-[#FAFAFA] rounded-md focus:outline-none"
            />
            <button
